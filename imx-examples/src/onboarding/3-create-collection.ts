...
(async (): Promise<void> => {
  ...
  const params: CreateCollectionParams = {
    name: 'Crocs',
    description: 'Crocs ejemplo',
    contract_address: collectionContractAddress,
    owner_public_key: ownerPublicKey,
    icon_url: 'https://raw.githubusercontent.com/Turupawn/ImmutableXAssetsDemo/master/Icon.png',
    metadata_api_url: 'https://raw.githubusercontent.com/Turupawn/ImmutableXAssetsDemo/master/metadata/',
    collection_image_url: 'https://raw.githubusercontent.com/Turupawn/ImmutableXAssetsDemo/master/CollectionImage.png',
